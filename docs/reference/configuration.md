...
| `otel.tracer_name` | `OTEL_TRACER_NAME` | 全局 OTel 埋点 Tracer 的实例化名称 | `github.com/XiaoLong-Taiwan/openflare-longshang` |
...
| `update_upstream_repository` | `string` | 系统检测自更新的 GitHub 仓库地址 | `XiaoLong-Taiwan/openflare-longshang` |
...
| `agent_update_repo` | `string` | Agent 节点更新下载自身二进制的 Release 仓库源 | `XiaoLong-Taiwan/openflare-longshang` |
