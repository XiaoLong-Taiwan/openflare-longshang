...
| `otel.tracer_name` | `OTEL_TRACER_NAME` | global OTel tracer instance name | `github.com/XiaoLong-Taiwan/openflare-longshang` |
...
| `update_upstream_repository` | `string` | GitHub repo for self-update detection | `XiaoLong-Taiwan/openflare-longshang` |
...
| `agent_update_repo` | `string` | Release repo source for Agent self-binary updates | `XiaoLong-Taiwan/openflare-longshang` |
