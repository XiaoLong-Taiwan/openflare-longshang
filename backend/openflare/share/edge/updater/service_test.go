...
func TestGetLatestPreviewRelease(t *testing.T) {
	service := testService(&http.Client{
		Transport: roundTripFunc(func(req *http.Request) (*http.Response, error) {
			if req.URL.String() != "https://api.github.com/repos/XiaoLong-Taiwan/openflare-longshang/releases?per_page=20" {
	...
	release, err := service.getRelease(context.Background(), "XiaoLong-Taiwan/openflare-longshang", UpdateOptions{Channel: "preview"})
	if err != nil {
...
func TestGetReleaseByTag(t *testing.T) {
	service := testService(&http.Client{
		Transport: roundTripFunc(func(req *http.Request) (*http.Response, error) {
			if req.URL.String() != "https://api.github.com/repos/XiaoLong-Taiwan/openflare-longshang/releases/tags/v1.1.0-rc.1" {
				t.Fatalf("unexpected request url: %s", req.URL.String())
			}
			return &http.Response{
				StatusCode: http.StatusOK,
	...
	release, err := service.getRelease(context.Background(), "XiaoLong-Taiwan/openflare-longshang", UpdateOptions{Channel: "preview", TagName: "v1.1.0-rc.1", Force: true})
	if err != nil {
...
func TestCheckAndUpdateRequiresChecksumSource(t *testing.T) {
	...
	service := testService(&http.Client{
		Transport: roundTripFunc(func(req *http.Request) (*http.Response, error) {
			if req.URL.String() != "https://api.github.com/repos/XiaoLong-Taiwan/openflare-longshang/releases/latest" {
				t.Fatalf("unexpected request url: %s", req.URL.String())
			}
			return &http.Response{
				StatusCode: http.StatusOK,
	...
	err := service.CheckAndUpdate(context.Background(), "XiaoLong-Taiwan/openflare-longshang", UpdateOptions{})
