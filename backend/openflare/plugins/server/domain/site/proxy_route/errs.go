...
const (
	...
	errProxyRouteUpstreamPriority     = "upstream priority must be greater than or equal to 0"
	errProxyRouteUpstreamPriorityTier = "upstreams support at most two priority tiers"
	errProxyRouteLoadBalancing        = "load_balancing must be round_robin or least_conn"
	...
	errProxyRouteConfigInvalid        = "代理规则配置无效"
	errProxyRouteCacheTTL             = "cache TTL must be unlimited or use a positive Nginx duration such as 30s, 90s, 2m, 2h, or 7d"
