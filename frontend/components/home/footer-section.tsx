        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-20'>
          <div className='lg:col-span-2 space-y-6'>
            ...
            <div className='flex gap-4 pt-2'>
              <SocialLink
                icon={GithubIcon}
                href='https://github.com/XiaoLong-Taiwan/openflare-longshang/'
              />
            </div>
          </div>
          ...
          <div className='lg:col-span-1'>
            ...
            <ul className='space-y-4 text-sm text-muted-foreground'>
              ...
              <li>
                <FooterLink href='https://github.com/XiaoLong-Taiwan/openflare-longshang'>
                  源代码
                </FooterLink>
              </li>
            </ul>
          ...
          <div className='lg:col-span-1'>
            ...
            <ul className='space-y-4 text-sm text-muted-foreground'>
              <li>
                <FooterLink href='https://github.com/XiaoLong-Taiwan/openflare-longshang/issues'>
                  GitHub Issues
                </FooterLink>
              </li>
              <li>
                <FooterLink href='https://github.com/XiaoLong-Taiwan/openflare-longshang/discussions'>
                  讨论
                </FooterLink>
              </li>
            </ul>
