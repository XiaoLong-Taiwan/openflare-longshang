...
const relayInstallerScriptUrl =
  'https://raw.githubusercontent.com/XiaoLong-Taiwan/openflare-longshang/main/scripts/install-relay.sh';

const flaredInstallerScriptUrl =
  'https://raw.githubusercontent.com/XiaoLong-Taiwan/openflare-longshang/main/scripts/install-flared.sh';
...
export function buildEdgeDockerInstallCommand(
  ...
  const image = `ghcr.io/XiaoLong-Taiwan/openflare-longshang-agent:${tag}`;
...
export function buildRelayDockerInstallCommand(
  ...
  const tag = getImageTag(version);
  const image = `ghcr.io/XiaoLong-Taiwan/openflare-longshang-relay:${tag}`;
...
export function buildTunnelDockerInstallCommand(
  ...
  const tag = getImageTag(version);
  const image = `ghcr.io/XiaoLong-Taiwan/openflare-longshangd:${tag}`;
