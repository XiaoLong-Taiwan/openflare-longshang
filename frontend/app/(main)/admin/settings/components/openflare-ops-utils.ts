...
export const defaultOpenFlareOpsFields: OpenFlareOpsFields = {
  ...
  agent_update_repo: 'XiaoLong-Taiwan/openflare-longshang',
...
export const INSTALLER_SCRIPT_URL =
  'https://raw.githubusercontent.com/XiaoLong-Taiwan/openflare-longshang/main/scripts/install-agent.sh';
