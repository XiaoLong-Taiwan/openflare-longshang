...
<p align="center">
  <a href="https://raw.githubusercontent.com/XiaoLong-Taiwan/openflare-longshang/main/LICENSE">
    <img src="https://img.shields.io/github/license/XiaoLong-Taiwan/openflare-longshang?color=brightgreen" alt="license">
  </a>
  <a href="https://github.com/XiaoLong-Taiwan/openflare-longshang/releases/latest">
    <img src="https://img.shields.io/github/v/release/XiaoLong-Taiwan/openflare-longshang?color=brightgreen&include_prereleases" alt="release">
  </a>
  <a href="https://github.com/XiaoLong-Taiwan/openflare-longshang/pkgs/container/openflare">
...
curl -o .env.example https://raw.githubusercontent.com/XiaoLong-Taiwan/openflare-longshang/refs/heads/main/.env.example
cp .env.example .env
```
...
services:
  openflare:
    image: ghcr.io/XiaoLong-Taiwan/openflare-longshang:latest
...
```bash
docker pull ghcr.io/XiaoLong-Taiwan/openflare-longshang-agent:latest
...
docker run -d --name openflare-agent --restart unless-stopped \
  ...
  ghcr.io/XiaoLong-Taiwan/openflare-longshang-agent:latest
```
...
<a href="https://www.star-history.com/?repos=xiaolong-taiwan%2FOpenFlare&type=date&legend=bottom-right">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=XiaoLong-Taiwan/openflare-longshang&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=XiaoLong-Taiwan/openflare-longshang&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=XiaoLong-Taiwan/openflare-longshang&type=date&legend=top-left" />
 </picture>
</a>
